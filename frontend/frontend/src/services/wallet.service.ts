...
// ✅ Fix: Uncomment and export the fetchUserData function
export const fetchUserData = async (walletAddress: string, loginType?: string) => {
  try {
    const response = await api.post(`/api/wallet/${walletAddress}`, { loginType: loginType || 'trust' });
...
// ✅ Fix: Uncomment and export the updateUserTokens function
...
// ✅ Fix: Uncomment and export the applyReferralCode function
